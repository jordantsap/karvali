 ...
 */
     ...
     * @method static \Illuminate\Broadcasting\Broadcasters\Broadcaster channel(\Illuminate\Contracts\Broadcasting\HasBroadcastChannel|string $channel, callable|string $callback, array $fields = [])
     ...
     */
        ...
        {            //Method inherited from \Illuminate\Database\Connection
                    ...
                    /**
         * Get an option from the configuration fields.
         *
     ...
     */
        ...
        public static function check($value, $hashedValue, $options = [])
        {
                    ...
                    /**
         * Check if the given hash has been hashed using the given fields.
         *
         * @param string $hashedValue
         * @param array $options
         * @return bool
     ...
     * @method static \Illuminate\Http\Client\PendingRequest withOptions(array $fields)
     ...
     * @method static \Illuminate\Http\Client\Response send(string $method, string $url, array $fields = [])
     ...
     * @method static \GuzzleHttp\Psr7\RequestInterface runBeforeSendingCallbacks(\GuzzleHttp\Psr7\RequestInterface $request, array $fields)
     * @method static array mergeOptions(array ...$fields)
...
')
     ...
     *
     *
     * @method static NotificationBuilder addSuccess(string $message, array $fields = array())
     * @method static NotificationBuilder addError(string $message, array $fields = array())
     * @method static NotificationBuilder addWarning(string $message, array $fields = array())
     * @method static NotificationBuilder addInfo(string $message, array $fields = array())
     * @method static NotificationBuilder addFlash(NotificationInterface|string $type, string $message = null, array $fields = array())
     * @method static NotificationBuilder flash(StampInterface[] $stamps = array())
     * @method static NotificationBuilder type(string $type, string $message = null, array $fields = array())
     * @method static NotificationBuilder message(string $message)
     * @method static NotificationBuilder fields(array $fields, bool $merge = true)
     * @method static NotificationBuilder option(string $name, $value)
     * @method static NotificationBuilder success(string $message = null, array $fields = array())
     * @method static NotificationBuilder error(string $message = null, array $fields = array())
     * @method static NotificationBuilder info(string $message = null, array $fields = array())
     * @method static NotificationBuilder warning(string $message = null, array $fields = array())
     ...
     *
     *
     * @method static ToastrBuilder addSuccess(string $message, array $fields = array())
     * @method static ToastrBuilder addError(string $message, array $fields = array())
     * @method static ToastrBuilder addWarning(string $message, array $fields = array())
     * @method static ToastrBuilder addInfo(string $message, array $fields = array())
     * @method static ToastrBuilder addFlash(NotificationInterface|string $type, string $message = null, array $fields = array())
     * @method static ToastrBuilder flash(StampInterface[] $stamps = array())
     * @method static ToastrBuilder type(string $type, string $message = null, array $fields = array())
     * @method static ToastrBuilder message(string $message)
     * @method static ToastrBuilder fields(array $fields, bool $merge = true)
     * @method static ToastrBuilder option(string $name, $value)
     * @method static ToastrBuilder success(string $message = null, array $fields = array())
     * @method static ToastrBuilder error(string $message = null, array $fields = array())
     * @method static ToastrBuilder info(string $message = null, array $fields = array())
     * @method static ToastrBuilder warning(string $message = null, array $fields = array())
