...
return [
    ...
    'cameras' => 'Κάμερες',
    'userlogin' => 'Είσοδος Διαφημιζόμενου',
    'customerlogin' => 'Είσοδος Πελατών',
    'sitemap' => 'SiteMap',
    'contact' => 'Επικοινωνία',
    'aboutus' => 'Σχετικά',
    'termsofuse' => 'Όροι Χρήσης',
    'posts' => 'Ειδήσεις',
    'userhelp' => 'Βοήθεια Διαφημιζόμενου',
    'customerhelp' => 'Βοήθεια Πελατών',
    ...
    'adminregister' => 'Εγγραφή Διαχειριστή',
    'user' => 'ΧΡΗΣΤΗΣ',
];
