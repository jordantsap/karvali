...
{{--                  @endcan--}}
                ...
                @foreach ($accommodations as $accommodation)
                  ...
                  <tr>
                    ...
                    <td>
                      @if( ! empty($accommodation->category)){{ $accommodation->category->name }}
                      @else None
                      @endif
                    </td>
...
{{--                    @can ('update_companies', App\Company::class)--}}
                      <a class="btn btn-primary" href="{{route('owner.company.edit', $accommodation->id)}}">Edit</a> -
{{--                    @endcan--}}
{{--                    @can ('view_companies', App\Company::class)--}}
                      <a class="btn btn-primary" href="{{route('owner.company.show', $accommodation->id)}}">View</a>
{{--                      @endcan--}}
{{--                        @can ('delete_companies', App\Models\Company::class)--}}
                            <form action="{{ route('owner.company.destroy', $accommodation->id) }}"
                                  method="POST">
                                {{ csrf_field() }}
                                {{ method_field('DELETE') }}
                                <br>
