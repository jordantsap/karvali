...
{{--              </div>--}}
              ...
              @foreach(config('translatable.locales') as $locale => $lang)
                  ...
                  <div class="col-xs-6">
                      <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                          ...
                          @endif
                          <div class="input-group">
                              <input type="text" class="form-control" name="{{$locale}}[title]" value="{{ $accommodation->title }}" id="title" placeholder="{{ $accommodation->title }}">
                              <span class="input-group-addon">
                  ...
                  <div class="col-xs-6 form-group{{ $errors->has('manager') ? ' has-error' : '' }}">
                      ...
                      @endif
                      <div class="input-group">
                          <input type="text" class="form-control" value="{{ $accommodation->manager }}" id="manager" name="{{$locale}}[manager]" placeholder="Manager Name" >
                          <span class="input-group-addon">
                    <span class="glyphicon glyphicon-user"></span>
                  </span>
                      </div>
              ...
              <div class="">
                ...
                <div class="col-xs-6 form-group{{ $errors->has('meta_description') ? ' has-error' : '' }}">
                    ...
                    @endif
                    <div class="input-group">
                        <input type="text" class="form-control" name="{{$locale}}[meta_description]" value="{{ $accommodation->meta_description }}" id="title" placeholder="{{ $accommodation->meta_description }}">
                        <span class="input-group-addon">
                <span class="glyphicon glyphicon-home"></span>
              </span>
                    </div>
                ...
                <div class="col-xs-6 form-group{{ $errors->has('meta_keywords') ? ' has-error' : '' }}">
                    ...
                    @endif
                    <div class="input-group">
                        <input type="text" class="form-control" name="{{$locale}}[meta_keywords]" value="{{ $accommodation->meta_keywords }}" id="title" placeholder="{{ $accommodation->meta_keywords }}">
                        <span class="input-group-addon">
                <span class="glyphicon glyphicon-home"></span>
              </span>
                    </div>
            ...
            <div class="">
              <div class="col-xs-3">
                  <div class="form-group{{ $errors->has('header') ? ' has-error' : '' }}">
                      ...
                      <div class="input-group">
                          ...
                          <p class="help-block">
                              <img id="headerPreview" src="#" alt="Image Preview 2" style="display: none; max-width: 300px;">
                          </p>
                      </div>
                  </div>
              </div>
              ...
              <div class="col-xs-3">
                  ...
                  <div class="form-group{{ $errors->has('logo') ? ' has-error' : '' }}">
                      ...
                      @endif
                      <div class="input-group">
                          <input type="file" id="logo" value="{{asset('images/accommodations/'.$accommodation->logo)}}" name="logo">
                          <p class="help-block">
                              <img id="logoPreview" src="#" alt="Image Preview 2" style="display: none; max-width: 300px;">
                          </p>
                      </div>
                  </div>
              </div>
              <div class="col-xs-3">
                  <div class="form-group{{ $errors->has('image1') ? ' has-error' : '' }}">
                      ...
                      @endif
                      <div class="input-group">
                          <input type="file" id="image1" value="{{asset('images/accommodations/'.$accommodation->image1)}}" name="image1">
                          <p class="help-block">
                              <img id="image1Preview" src="#" alt="Image Preview 2" style="display: none; max-width: 300px;">
                          </p>
                      </div>
                  </div>
              </div>
              <div class="col-xs-3">
                  <div class="form-group{{ $errors->has('image2') ? ' has-error' : '' }}">
                      ...
                      @endif
                      <div class="input-group">
                          <input type="file" id="image2" value="{{asset('images/accommodations/'.$accommodation->image2)}}" name="image2">
                          <p class="help-block">
              ...
              <div class="col-xs-3">
                  <div class="form-group{{ $errors->has('image3') ? ' has-error' : '' }}">
                      ...
                      @endif
                      <div class="input-group">
                          <input type="file" id="image3" value="{{asset('images/accommodations/'.$accommodation->image3)}}" name="image3">
                          <p class="help-block">
