...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      Edit Venue<small>{{$venue->title}}</small>
        ...
        <div class="box-body">
            ...
            <div class="row">
              <div class="col-xs-2 form-group">
                <label for="active">{{__('form.published')}}</label>
                  &nbsp<input type="checkbox" name="active" value="1" @if ($venue->active == 1)
                    {{'checked'}}
                  @endif>
                </label>
              </div>
              <div class="col-xs-5 form-group{{ $errors->has('entrance') ? ' has-error' : '' }}">
                ...
                <div class="input-group">
                  <input type="text" value="{{ $venue->entrance }}" class="form-control" id="entrance" name="entrance" placeholder="{{__('form.entranceprice')}}" required>
              ...
              <div class="col-xs-5 form-group{{ $errors->has('telephone') ? ' has-error' : '' }}">
                ...
                @endif
                <div class="input-group">
                  <input type="text" value="{{ $venue->telephone }}" class="form-control" id="telephone" name="telephone" placeholder="{{__('form.telephone')}}" required>
                  <span class="input-group-addon">
            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    <div class="form-group{{ $errors->has('website') ? ' has-error' : '' }}">
                        ...
                        @endif
                        <div class="input-group">
                            <input type="text" value="{{ $venue->website }}" class="form-control" id="website" name="website" placeholder="Website">
                            <span class="input-group-addon">
                ...
                <div class="col-xs-6">
                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                        ...
                        @endif
                        <div class="input-group">
                            <input type="email" value="{{ $venue->email }}" class="form-control" id="email" name="email" placeholder="E-Mail">
                            <span class="input-group-addon">
                ...
                <div class="col-xs-6">
                    <div class="form-group{{ $errors->has('facebook') ? ' has-error' : '' }}">
                        ...
                        @endif
                        <div class="input-group">
                            <input type="text" value="{{$venue->facebook }}" class="form-control" id="facebook" name="facebook" placeholder="facebook">
                            <span class="input-group-addon">
                ...
                <div class="col-xs-6">
                    <div class="form-group{{ $errors->has('twitter') ? ' has-error' : '' }}">
                        ...
                        @endif
                        <div class="input-group">
                            <input type="text" value="{{ $venue->twitter }}" class="form-control" id="twitter" name="twitter" placeholder="Twitter">
                            <span class="input-group-addon">
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                            ...
                            @endif
                            <div class="input-group">
                                <input type="text" value="{{ $venue->title }}" class="form-control" name="{{$locale}}[title]" id="title" placeholder="Enter Name" required>
                                <span class="input-group-addon">
                  <span class="glyphicon glyphicon-home"></span>
                    ...
                    <div class="col-xs-6">
                        <div class="form-group{{ $errors->has('manager') ? ' has-error' : '' }}">
                            <label for="manager">Ονομα Υπεύθυνου - ({{$lang}})</label>
                            @if ($errors->has('manager'))
                                <strong class="text-danger">{{ $errors->first('manager') }}</strong>
                            @endif
                            <div class="input-group">
                                <input type="text" value="{{ $venue->manager }}" class="form-control" name="{{$locale}}[manager]" id="manager" placeholder="Enter Name" required>
                                <span class="input-group-addon">
                  <span class="glyphicon glyphicon-home"></span>
                </span>
                            </div>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="form-group{{ $errors->has('meta_description') ? ' has-error' : '' }}">
                            ...
                            @endif
                            <div class="input-group">
                                <input type="text" value="{{ $venue->meta_description }}" class="form-control" name="{{$locale}}[meta_description]" id="meta_description" placeholder="meta_description" required>
                                <span class="input-group-addon">
                  <span class="glyphicon glyphicon-home"></span>
                </span>
                            </div>
                    ...
                    <div class="col-xs-6">
                        <div class="form-group{{ $errors->has('meta_keywords') ? ' has-error' : '' }}">
                            ...
                            @endif
                            <div class="input-group">
                                <input type="text" value="{{ $venue->meta_keywords }}" class="form-control" name="{{$locale}}[meta_keywords]" id="meta_keywords" placeholder="meta_keywords" required>
                                <span class="input-group-addon">
                  <span class="glyphicon glyphicon-home"></span>
                </span>
                            </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            @endif
                            <div class="input-group">
                                <textarea name="{{$locale}}[description]" placeholder="Description" id="description" class="form-control" rows="5" required>{{ $venue->description }}</textarea>
                                <span class="input-group-addon">
