...
{{--      @can ('update-venues', App\Models\Venue::class)--}}
        <small><a class="btn btn-primary" href="{{route('owner.venues.edit', $venue->slug)}}">Edit</a> - <a class="btn btn-warning" href="javascript:history.back()">Go Back</a></small>
{{--      @endcan--}}
    </h1>
  </section>
      ...
      <div class="box-body">
          ...
          <div class="row">
            ...
            <div class="col-xs-5 form-group">
              ...
              <div class="input-group">
                <input type="text" placeholder="{{ $venue->entrance }}" class="form-control" id="entrance" name="entrance">
                <span class="input-group-addon">
        ...
        <div class="form-group">
          ...
          <div class="input-group">
            <img width="100%" height="200px" src="{{ asset('images/events/'.$venue->header) }}" alt="{{ $venue->title }}">
          </div>
        </div>
