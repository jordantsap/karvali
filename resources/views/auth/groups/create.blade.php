...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <!-- Default box -->
    <div class="box">
      <form action="{{ route('owner.groups.store') }}" method="post" role="form" enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="box-body">
              ...
              <div class="row">
                ...
                @foreach(config('translatable.locales') as $locale => $lang)
                  ...
                  <div class="row">
                      <div class="col-xs-6">
                          <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                              ...
                              @endif
                              <div class="input-group">
                                  <input type="text" value="{{old('title')}}" class="form-control" name="{{$locale}}[title]" id="title" placeholder="Enter Name" >
                                  <span class="input-group-addon">
                      ...
                      <div class="col-xs-6">
                          <div class="form-group{{ $errors->has('manager') ? ' has-error' : '' }}">
                              <label for="manager">{{__('form.managername')}}</label>
                              @if ($errors->has('manager'))
                                  <strong class="text-danger">{{ $errors->first('manager') }}</strong>
                              @endif
                              <div class="input-group">
                                  <input type="text" class="form-control" id="manager" name="{{$locale}}[manager]" placeholder="Για περαιτέρω διευκρινήσεις" >
                                  <span class="input-group-addon">
                  ...
                  <div class="col-xs-6 form-group{{ $errors->has('meta_description') ? ' has-error' : '' }}">
                      ...
                      @endif
                      <div class="input-group">
                          <input type="text" value="{{old('meta_description')}}" class="form-control" name="{{$locale}}[meta_description]" id="meta_description" placeholder="meta_description" >
                          <span class="input-group-addon">
                <span class="glyphicon glyphicon-home"></span>
              </span>
                      </div>
                  ...
                  <div class="col-xs-6 form-group{{ $errors->has('meta_keywords') ? ' has-error' : '' }}">
                      ...
                      @endif
                      <div class="input-group">
                          <input type="text" value="{{old('meta_keywords')}}" class="form-control" name="{{$locale}}[meta_keywords]" id="meta_keywords" placeholder="meta_keywords" >
                          <span class="input-group-addon">
                <span class="glyphicon glyphicon-home"></span>
              </span>
                      </div>
                  ...
                  <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                      ...
                      @endif
                      <div class="input-group">
                          <textarea name="{{$locale}}[description]" id="description" class="form-control" rows="5" ></textarea>
                          <span class="input-group-addon">
