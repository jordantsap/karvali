  ...
  <section class="content-header">
    <h1>
      ...
      @can ('update-groups', App\Models\Group::class)
        <small><a class="btn btn-primary" href="{{route('owner.groups.edit', $group->id)}}">Edit</a> - <a class="btn btn-warning" href="javascript:history.back()">Go Back</a></small>
      @endcan
    </h1>
  </section>
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="form-group">
        ...
        <div class="input-group">
          <img width="100%" height="200px" src="{{ asset($group->header) }}" alt="">
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-xs-3">
          <div class="form-group">
            ...
            <div class="input-group">
              <img width="100%" height="200px" src="{{ asset($group->logo) }}" alt="">
            </div>
          </div>
        </div>
        <div class="col-xs-3">
          <div class="form-group">
            ...
            <div class="input-group">
              <img width="100%" height="200px" src="{{ asset($group->image1) }}" alt="">
            </div>
          </div>
        </div>
        <div class="col-xs-3">
          <div class="form-group">
            ...
            <div class="input-group">
              <img width="100%" height="200px" src="{{ asset($group->image2) }}" alt="">
            </div>
          </div>
        </div>
        <div class="col-xs-3">
          <div class="form-group">
            ...
            <div class="input-group">
              <img width="100%" height="200px" src="{{ asset($group->image3) }}" alt="">
            </div>
          </div>
        </div>
      </div>
