...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      Event : {{$event->title}}
      @can ('update-events', App\Models\Event::class)
        <small><a class="btn btn-primary" href="{{route('owner.events.edit', $event->id)}}">Edit</a> - <a class="btn btn-warning" href="javascript:history.back()">Go Back</a></small>
      @endcan
    </h1>
  </section>
    ...
    <div class="box">
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <div class="input-group">
            <img width="100%" height="200px" src="{{ asset($event->header) }}" alt="{{ $event->title }}">
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-xs-3">
            <div class="form-group">
              ...
              <div class="input-group">
                <img width="100%" height="200px" src="{{ asset($event->logo) }}" alt="{{ $event->title }}">
              </div>
            </div>
          </div>
          <div class="col-xs-3">
            <div class="form-group">
              ...
              <div class="input-group">
                <img width="100%" height="200px" src="{{ asset($event->image1) }}" alt="{{ $event->title }}">
              </div>
            </div>
          </div>
          <div class="col-xs-3">
            <div class="form-group">
              ...
              <div class="input-group">
                <img width="100%" height="200px" src="{{ asset($event->image2)}}" alt="{{ $event->title }}">
              </div>
            </div>
          </div>
          <div class="col-xs-3">
            <div class="form-group">
              ...
              <div class="input-group">
                <img width="100%" height="200px" src="{{ asset($event->image3) }}" alt="{{ $event->title }}">
              </div>
            </div>
          </div>
            @if($event->images)
                <div class="container-fluid">
                    <div class="row">
                        ...
                        @foreach($event->images as $upload)
