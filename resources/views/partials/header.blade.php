            ...
            <div class="">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a href="{{ route('front.rooms') }}">{{ __('Rooms') }}</a>
                        </li>
                        <li>
                        ...
                        <li class="dropdown">
                            ...
                            @auth ('web')
                                <a href="{{url('manage')}}">
                                    {{-- class="dropdown-toggle" data-toggle="dropdown web" aria-expanded="false" aria-haspopup="true" id="web"> --}}
                            ...
                            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="cart">
                                @if(Cart::count() == 1)
                                    ...
                                    <a class="list-group-item"
                                       href="{{ route('cart.index') }}">{{ __('cart.cart') }}</a>
                                    <li class="list-group-item">
                                ...
                                @else
                                    ...
                                    <a href="{{route('front.companies')}}"
                                       class="list-group-item">{{ __('cart.gotocompanies') }}</a>
                                @endif
                            </ul>
                        </li>
                        <li class="dropdown">
