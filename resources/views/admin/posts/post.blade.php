    ...
    <div class="box">
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <input type="text" value="{{$post->meta_description}}" class="form-control" id="meta_description" disabled>
          </div>
          <div class="form-group">
            <label for="title">Meta Keywords</label>
            <input type="text" value="{{$post->meta_keywords}}" class="form-control" id="meta_keywords" disabled>
          </div>
          <div class="checkbox">
            <label>
