          ...
          <div class="row">
            <div class="col-xs-6 form-group{{ $errors->has('link_title') ? ' has-error' : '' }}">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" value="{{ old('link_title') }}" id="link_title" name="link_title" placeholder="π.χ. Κατάστημα αθλητικών ειδών" >
              </div>
            </div>
            <div class="col-xs-6 form-group{{ $errors->has('banner_alt') ? ' has-error' : '' }}">
              ...
              <div class="input-group">
                <span>(Βοηθάει στις μηχανες αναζήτησης)</span>
                <input type="text" class="form-control" value="{{ old('banner_alt') }}" id="banner_alt" name="banner_alt" placeholder="π.χ. Ρούχο για το βαρύ χειμώνα" >
              </div>
            </div>
          </div>
          <div class="row">
