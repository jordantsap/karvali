        ...
        <section class="content-header">
            <h1>
                ...
                <!-- @ can ('create', App\Models\ProductType::class) -->
                    <small><a class="btn btn-primary" href="{{route('admin.company-types.create')}}">Add New</a></small>
                <!-- @ endcan -->
            </h1>
        </section>
...
{{--                                    @endcan--}}
                                ...
                                @foreach ($companyTypes as $accommodationType)
                                    <tbody>
                                    <tr>
...
{{--                                                <a class="btn btn-primary" href="{{route('admin.company-types.edit', $accommodationType->id)}}">Edit</a> ---}}
{{--                                            @endcan--}}
{{--                                            @can ('view', App\Models\AccommodationType::class)--}}
{{--                                                <a class="btn btn-primary" href="{{route('admin.company-types.show', $accommodationType->id)}}">View</a>--}}
{{--                                            @endcan--}}
                                            <!-- @ can ('delete-productType', [$accommodationType, App\Models\AccommodationType::class]) -->
                                                <form action="{{ route('admin.company-types.destroy', $accommodationType->id) }}"
                                                      method="POST">
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}
