...
@section('title', $producttype->name.' '.__('head.productcategory'))
@section('meta_description', __('meta.productcategorydescription').' '.$producttype->name)
@section('meta_keywords', $producttype->name.' '. __('meta.productcategorykeywords'))
