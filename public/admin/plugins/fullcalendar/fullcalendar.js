...
// TODO: document the structure and ordering of a FullCalendar late-lang file

// TODO: rename everything "late-lang" to "locale", like what the moment project did
	...
	function getViewSpec(requestedViewType) {
		...
		if (viewClass) {
			...
			buttonText =
				...
				(unitIsSingle ? allDefaultButtonText[unit] : null) || // late-lang data, like "week"
