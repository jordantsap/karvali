...
// TODO: document the structure and ordering of a FullCalendar oldv78lang file

// TODO: rename everything "oldv78lang" to "locale", like what the moment project did
	...
	function getViewSpec(requestedViewType) {
		...
		if (viewClass) {
			...
			buttonText =
				...
				allDefaultButtonText[requestedViewType] || // oldv78lang data, like "agendaWeek"

				(unitIsSingle ? allDefaultButtonText[unit] : null) || // oldv78lang data, like "week"
