<section id="packages" class="bg-info">
  <div class="container-fluid">
    <div class="row-fluid">
      <h1 id="welcomehead" class="page-header text-center">Πακέτα Διαφήμισης</h1>
      <div class="divider"></div>
      <div class="col-md-3 col-featured">
        ...
        <div class="col-body">
          <ul class="list-group">
            <li class="list-group-item">
              <i class="fas fa-calendar"></i> Εγγραφή ενός μήνα χωρίς χρέωση.</li>
            <li class="list-group-item">
        ...
        <div class="col-footer text-center">
          <div class="col-xs-9">
            <a href="<?php echo e(url('freepackage')); ?>" id="btn" title="Εγγραφή Χρήστη" class="btn btn-block btn-lg btn-primary"><?php echo e(__('Εγγραφή')); ?></a>
          </div>
          <div class="col-xs-1">
      ...
      <div class="col-md-3 col-featured">
        <div class="col-header text-center">
          <h3 class="page-header">Κύριο Πακέτο</h3>
          <h4>
                <span class="big-number">Διαφήμιση 30 ημερών με 10€/Μήνα</span>
              </h4>
        </div>
        <div class="col-body">
          <ul class="list-group">
        ...
        <div class="col-footer text-center">
          <div class="col-xs-9">
            <a href="<?php echo e(url('mainpackage')); ?>" id="btn" title="Εγγραφή Χρήστη" class="btn btn-block btn-lg btn-primary"><?php echo e(__('Εγγραφή')); ?></a>
          </div>
          <div class="col-xs-1">
      ...
      <div class="col-md-3 col-featured ">
        ...
        <div class="col-footer text-center">
          <div class="col-xs-9">
            <a href="<?php echo e(url('mediumpackage')); ?>" id="btn" title="Εγγραφή Χρήστη" class="btn btn-block btn-lg btn-primary"><?php echo e(__('Εγγραφή')); ?></a>
          </div>
          <div class="col-xs-1">
      ...
      <div class="col-md-3 col-featured">
        <div class="col-header text-center">
          <h3 class="page-header">Μεγάλο Πακέτο</h3>
          <h4>
                <span class="big-number">Διαφήμιση 30 ημερών με 30€/Μήνα</span>
              </h4>
        </div>
        <div class="col-body">
          <ul class="list-group">
        ...
        <div class="col-footer text-center">
          <div class="col-xs-9">
            <a href="<?php echo e(url('advancedpackage')); ?>" id="btn" title="Εγγραφή Χρήστη" class="btn btn-block btn-lg btn-primary"><?php echo e(__('Εγγραφή')); ?></a>
          </div>
          <div class="col-xs-1">
...
<?php /**PATH L:\2.2.drive\xampp\htdocs\karvali\resources\views/home/packages.blade.php ENDPATH**/ ?>