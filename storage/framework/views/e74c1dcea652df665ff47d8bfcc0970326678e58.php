        ...
        <div class="col-xs-10">
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-6">
              ...
              <p><?php echo e(str_limit($event->description, 100)); ?></p>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/karvali/resources/views/events/index.blade.php ENDPATH**/ ?>