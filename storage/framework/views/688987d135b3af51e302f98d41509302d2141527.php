<aside class="col-xs-2">
  <ul class="list-group">
    <li class="list-group-item">
      <a href="<?php echo e(route('online-cameras')); ?>"><?php echo e(__('sidebar.cameras')); ?></a>
    </li>
    <li class="list-group-item">
...
<?php /**PATH L:\2.2.drive\xampp\htdocs\karvali\resources\views/information/sidebar.blade.php ENDPATH**/ ?>