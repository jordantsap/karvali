          ...
          <div class="col-xs-12">
            ...
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-6 col-md-3 portfolio-item">
                ...
                <div class="card-body">
                  <h4 class="card-title">
                      <a href="<?php echo e(route('company',$company->slug)); ?>"><?php echo e(Str::limit($company->title, 15)); ?></a>
                    </h4>
...
<?php /**PATH L:\2.2.drive\xampp\htdocs\karvali\resources\views/home/popular.blade.php ENDPATH**/ ?>