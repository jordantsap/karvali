          ...
          <div class="col-xs-12">
            ...
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-6 col-md-3 portfolio-item">
                ...
                <div class="card-body">
                  <h4 class="card-title">
                      <a href="<?php echo e(route('company',$company->slug)); ?>"><?php echo e(str_limit($company->title, 15)); ?></a>
                    </h4>
                  ...
                  <div class="row">
                    <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="col-xs-12 col-sm-6 col-md-3 portfolio-item">
                        ...
                        <div class="card-body">
                          <h4 class="card-title">
                            <a href="<?php echo e(route('group',$group->slug)); ?>"><?php echo e(str_limit($group->title, 15)); ?></a>
                          </h4>
                          <div class="row" id="likecomment">
                            <div class="col-xs-6 text-center">
                              <i class="fas fa-2x fa-thumbs-up"></i>
          ...
          <div class="col-xs-12">
            ...
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-6 col-md-3 portfolio-item">
                ...
                <div class="card-body">
                  <h4 class="card-title">
                          <a href="<?php echo e(route('product',$product->slug)); ?>"><?php echo e(str_limit($product->title, 15)); ?></a>
                        </h4>
                  <div class="row" id="likecomment">
                    <div class="col-xs-6 text-center">
                      <i class="fas fa-2x fa-thumbs-up"></i>
                  ...
                  <div class="row">
                    <div class="col-xs-12"><b><?php echo e(__('page.company')); ?></b>
                      <a href="<?php echo e(route('company', $product->company->slug)); ?>">
                        <?php echo e(str_limit($product->company->title, 10)); ?></a>
                    </div>
                  </div>
                  <br>
                  <div class="row">
                ...
                <div class="row">
                  <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-xs-6 col-sm-3 portfolio-item">
                      ...
                      <h4 class="card-title"><a href="<?php echo e(route('event',$event->slug)); ?>"><?php echo e(str_limit($event->title, 15)); ?></a></h4>
                      <div class="row" id="likecomment">
                        <div class="col-xs-6 text-center">
                          <i class="fas fa-2x fa-thumbs-up"></i>
                      ...
                      <div><?php echo str_limit($event->description, 50); ?></div>
                      <br>
...
<?php /**PATH /opt/lampp/htdocs/karvali/resources/views/home/popular.blade.php ENDPATH**/ ?>