...
<section id="categories">
          ...
          <div class="scroll-animation-in right">
            ...
            <div class="col-xs-3 text-center">
              <div class="animated slideInRight">
                <h3><?php echo e(__('page.events')); ?></h3>
              </div>
              <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="list-group-item">
                  <a href="<?php echo e(route('event', $event->slug)); ?>"> <h4 class="animated slideInUp"><?php echo e($event->title); ?></h4> </a>
                </li>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
					</div><!-- /.row -->
...
<?php /**PATH L:\xampp\htdocs\karvali\resources\views/home/categories.blade.php ENDPATH**/ ?>