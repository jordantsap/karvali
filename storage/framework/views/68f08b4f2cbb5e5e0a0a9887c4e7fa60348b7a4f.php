        ...
        <div class="panel-heading">
          ...
          <?php if(count($company->products->where('active',1)) > 0): ?>
            <?php $__currentLoopData = $company->products->where('active',1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="col-xs-3">
                <ul class="list-group">
                  <li class="list-group-item"><h2><?php echo e($company->title); ?></h2>
                  </li>
          ...
          <li class="list-group-item">
            <h3><?php echo e($company->description); ?></h3>
          </li>
          <li class="list-group-item">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH L:\2.2.drive\xampp\htdocs\karvali\resources\views/companies/show.blade.php ENDPATH**/ ?>