<?php $__env->startSection('title', $producttype->name.' '.__('head.productcategory')); ?>
<?php $__env->startSection('meta_description', __('meta.productcategorydescription').' '.$producttype->name); ?>
<?php $__env->startSection('meta_keywords', $producttype->name.' '. __('meta.productcategorykeywords')); ?>
             ...
             <div class="col-xs-12 col-sm-6 col-md-4 portfolio-item">
               ...
               <div class="card-body">
                 <div class="card-title">
                   <a target="_blank" target="_blank" href="<?php echo e(route('product',$product->slug)); ?>">
                   <h2><?php echo e(str_limit($product->title, 30)); ?></h2></a>
                 </div>
                 <div class="row" id="likecomment">
                   ...
                   <div class="row">
                     <div class="col-xs-8"><h4><b><?php echo e(__('page.company')); ?></b> <a href="<?php echo e(route('company',$product->company->slug)); ?>"><br><?php echo e(str_limit($product->company->title, 10)); ?></a></h4></div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/karvali/resources/views/products/category.blade.php ENDPATH**/ ?>