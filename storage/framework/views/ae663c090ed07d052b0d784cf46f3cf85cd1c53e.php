             ...
             <div class="col-xs-12 col-sm-4 portfolio-item">
               ...
               <div class="card-body">
                 <div class="card-title">
                   <a target="_blank" href="<?php echo e(route('product',$product->slug)); ?>">
                   <h2><?php echo e(str_limit($product->title, 20)); ?></h2></a>
                 </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/karvali/resources/views/products/index.blade.php ENDPATH**/ ?>