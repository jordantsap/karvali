...
<?php $__env->startSection('title', $posttype->name.' '.__('head.postcategory')); ?>
<?php $__env->startSection('meta_description', $posttype->name.' '.__('meta.postcategorydescription')); ?>
<?php $__env->startSection('meta_keywords', $posttype->name.' '.__('meta.postcategorykeywords')); ?>
        ...
        <?php if(count($posts) > 0): ?> <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="col-xs-12 col-sm-6 col-md-4 portfolio-item">
            ...
            <div class="card-body text-center">
              <h2 class="card-title">
                  <a href="<?php echo e(route('news.show',$post->slug)); ?>"><?php echo e(str_limit($post->title, 30)); ?></a>
                </h2>
              <div class="row">
                <div class="col-xs-12">
                ...
                <div class="col-xs-12">
                  ...
                  <?php echo str_limit($post->description, 50); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/karvali/resources/views/posts/category.blade.php ENDPATH**/ ?>