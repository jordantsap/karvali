<?php $__env->startSection('title', __('head.companiespagetitle')); ?>
<?php $__env->startSection('meta_description', __('meta.companiespagedescription')); ?>
<?php $__env->startSection('meta_keywords', __('meta.companiespagekeywords')); ?>
         ...
         <?php if(count($companies) > 0): ?>
           ...
           <div class="card h-100">
             ...
             <div class="card-body text-center">
               <h2 class="card-title">
                 <a href="<?php echo e(route('company',$company->slug)); ?>"><?php echo e(str_limit($company->title, 20)); ?></a>
               </h2>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/karvali/resources/views/companies/index.blade.php ENDPATH**/ ?>