         ...
         <?php if(count($groups) > 0): ?>
           ...
           <div class="card h-100">
             ...
             <div class="card-body text-center">
               <h2 class="card-title">
                 <a href="<?php echo e(route('group',$group->slug)); ?>"><?php echo e(str_limit($group->title, 20)); ?></a>
               </h2>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/karvali/resources/views/groups/index.blade.php ENDPATH**/ ?>